...
def get_ip_data():
    ...
    color = input("I'm Buddy the Elf. What's your favorite color? ")
    language = input("How many coding languages do you know? ")
    d = {"IP": input_ip, "driver": input_driver, "Favorite Color": color, "Coding Languages": language}
    return d
