...
def nagWindow():
    sg.theme('dark grey 9')  # Establish window color theme
    ...
    while True:
        ...
        if event == sg.WINDOW_CLOSED or event == 'Quit':
            ...
            sg.Popup(sitesBlocked, no_titlebar=True)
        elif event == 'Ok':
...
def main():
    ...
    while True:
        ...
        if event == sg.WINDOW_CLOSED or event == 'Quit':
            ...
            sg.Popup(sitesBlocked, title='These websites are blocked')
        elif event == 'Ok':
            try:
                response = client.query(values[0])
                # Output a message to the window
                ...
                sg.Popup("Sorry, kid. Try google.com")
